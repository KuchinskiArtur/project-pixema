...
const Registration = () => {
  ...
  const LoginClick = () => navigate(Path.Login);
    ...
    switch (event.target.id) {
      case "name":
        ...
        if (!value.trim()) {
          ...
          setNameError("Entered incorrectly name");
        } else {
          setNameError("");
        }
        break;
      ...
      case "confirmPassword":
        ...
        if (!value.trim()) {
          setConfirmPasswordError("Empty field");
    ...
    <div className="form">
      <div className="form__container">
        ...
        <div className="form__item">
          ...
          ></Input>
          {nameDirty && nameError && (
            <span className="form__item__error">{nameError}</span>
          )}
        </div>
        <div className="form__item">
        ...
        <p className="form__footer">
          Already have an account? <span onClick={LoginClick}>Sign In</span>
        </p>
      </div>
    </div>
  );
